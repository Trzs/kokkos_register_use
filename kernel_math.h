...
KOKKOS_INLINE_FUNCTION static CUDAREAL *rotate_axis1(const CUDAREAL * v, CUDAREAL * newv, const vector_cudareal_t axis, const CUDAREAL phi);
...
KOKKOS_INLINE_FUNCTION CUDAREAL *rotate_axis1(const CUDAREAL * v, CUDAREAL * newv, const vector_cudareal_t axis, const CUDAREAL phi) {
